      ...
      children: [
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        "Đây là danh sách đề tài cần thực hiện",
                        style: TextStyle(
                          fontSize: 13,
        ...
        Positioned(
          ...
          child: Container(
            ...
            child: ListView(
              children: [
                buildTitleRow("ĐỀ TÀI HÔM NAY", 3),
                SizedBox(
                  height: 20,
                ),
                buildClassItem(),
                ...
                buildTitleRow("NHIỆM VỤ CẦN LÀM", 4),
                SizedBox(
                  height: 20,
                ),
                SingleChildScrollView(
                  ...
                  child: Row(
                    children: [
                      buildTaskItem(
                          3, "Quản lý hệ thống CD", Colors.red),
                      buildTaskItem(3, "Thiết kế giao diện....",
                          Colors.green),
                      buildTaskItem(3, "Thiết kế database...",
                          Colors.green),
                    ],
                  ),
                )
